...
set_background("/workspaces/CNC_Performance_Analysis/bg.jpg")
# Load the trained model
model = load_model("cnc_model.h5")

# Navigation
st.sidebar.title("Navigation")
page = st.sidebar.selectbox("Select Page", ["Introduction", "Model Prediction"])

if page == "Introduction":
    st.title("Welcome to CNC Milling Performance Analysis")
    st.write("This application helps in analyzing CNC milling performance and detecting faults using a deep learning model.")
    st.write("\n**Features:**")
    st.write("- Upload sensor data for analysis.")
    st.write("- Get predictions on CNC milling performance.")
    st.write("- Improve maintenance with AI-powered fault detection.")
